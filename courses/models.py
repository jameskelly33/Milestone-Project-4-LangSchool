...
class Course(models.Model):
    ...
    course_category = models.ForeignKey('Category', null=True, blank=True,
    ...
    maximum_age = models.DecimalField(max_digits=2, decimal_places=0,
                                      blank=True, null=True,
                                      validators=[MinValueValidator(5,
                                                  message="Minimum Age is 5")])
    cost_per_week = models.DecimalField(max_digits=10,
                                        decimal_places=2, default=0)
    course_levels = models.CharField(max_length=50,
    ...
    def _generate_course_id(self):
        course_number = Course.objects.filter(
                         course_category=self.course_category).count()
